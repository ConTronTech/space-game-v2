...
package/modules/world/     starfield, skybox, star_system (IStarSystem), asteroids (IAsteroids), stations (IStations), anomalies (IAnomalies), solar_flares (ISolarFlares: periodic sun eruptions, docs/SOLAR_FLARES.md), distress_beacons (IDistressBeacons: timed distress signals, black box + ore, docs/DISTRESS_BEACONS.md), cargo_pods (ICargoPods: ambient drifting loot pods, magnet pickup, docs/CARGO_PODS.md), atmosphere (planet rim glow, visual only: docs/ATMOSPHERE.md)
