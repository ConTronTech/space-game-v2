...
#      LAPTOP_DIR (default space-game-v2, mirrors the main rig's relative path), BENCH_SECONDS (default 15), SYNC=0 to skip the copy.
...
DIR=${LAPTOP_DIR:-space-game-v2}; SECS=${BENCH_SECONDS:-15}
