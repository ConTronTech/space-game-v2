...
# Env: LAPTOP_HOST (default contolis@192.168.1.150), LAPTOP_KEY (default ~/.ssh/id_ed25519_spacegame_laptop),
#      LAPTOP_DIR (default space-game-v2-test), BENCH_SECONDS (default 15), SYNC=0 to skip the copy.
...
set -euo pipefail
cd "$(dirname "$0")/../.."
HOST=${LAPTOP_HOST:-contolis@192.168.1.150}; KEY=${LAPTOP_KEY:-$HOME/.ssh/id_ed25519_spacegame_laptop}
DIR=${LAPTOP_DIR:-space-game-v2-test}; SECS=${BENCH_SECONDS:-15}
